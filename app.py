...
def book_instance(book_name):
    ...
    if book_name == 'beloved':
        ...
        book['genre'] = "Fiction"
        book['thumbnail_url'] = "http://books.google.com/books/content?id=d84AspgFjSwC&printsec=frontcover&img=1&source=gbs_api"
        ...
        book['genre'] = "Fiction"
        book['thumbnail_url'] = "http://books.google.com/books/content?id=kotPYEqx7kMC&printsec=frontcover&img=1&source=gbs_api"
